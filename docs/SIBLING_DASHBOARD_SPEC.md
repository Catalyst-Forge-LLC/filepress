...
| Start/stop `filepress dev` | LocalBerth claim vs read, firewall, leftover Vite processes |
...
1. **M1 bind port** — fixed LocalBerth lease vs ephemeral vs `FILEPRESS_YARD_PORT`?
